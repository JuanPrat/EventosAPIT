    ...
    const renderSwitchPage = () => {
        switch (page) {
            ...
            case 'register-institution':
                return <CreateInstitutionPage></CreateInstitutionPage>
        ...
        <div className="administration-container">
            <div className="side-menu">
                <div id="sidebar-container" className='container'>
                    ...
                    <button onClick={(event) => handleAdministrationButton(event)} id="register-institution">Registrar Institucion</button>
